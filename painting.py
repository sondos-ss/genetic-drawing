...
class Painting:
    def __init__(self, num_triangles, target_image_path, background_color=(0,0,0)):
    ...
    def _mate_possible(a,b) -> bool:
        return all([a.num_triangles==b.num_triangles, a.get_img_width==b.get_img_width, a.get_img_height==b.get_img_height])
    ...
    def mate(a,b):
        ...
        new_background = tuple(int((ab[i]+bb[i])/2) for i in range(3))
        child_a = Painting(0, a.target_image_path, background_color=new_background)
        child_b = Painting(0, a.target_image_path, background_color=new_background)
